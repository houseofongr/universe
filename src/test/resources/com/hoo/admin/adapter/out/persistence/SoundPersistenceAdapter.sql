...
values (1, '2025.06.09 10:30', '2025.06.09 10:30', '피스는 조각입니다.', -1, '조각', 0.3, 0.2, 0.2, 0.3, null, 1, false);


insert into SOUND(ID, AUDIO_FILE_ID, TITLE, DESCRIPTION, HIDDEN, PIECE_ID, CREATED_TIME, UPDATED_TIME)
values (1, 1, '소리', '사운드는 소리입니다.', true, 1, '2025-06-13 05:00', '2025-06-13 05:00');